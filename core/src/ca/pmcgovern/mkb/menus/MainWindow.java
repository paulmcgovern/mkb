...
public class MainWindow extends MkbMenu {


    
    public MainWindow( String title, Skin skin ) {
        ...
        topTable.setBackground( skin.getDrawable( "speech-top" ));
        ...
        botTable.setBackground( skin.getDrawable( "speech-bottom" ));        
