  ...
  //  }
    ...
    public synchronized int saveTask( Task t ) {
        ...
        if( t.getId() < 1 ) {
            ...
            int targetId = t.getId();
            int targetIdx = -1;
            
            for( int i = 0; i < count; i++ ) {
                if( allTasks.get( i ).getId() == targetId ) {
                    targetIdx = i;
                    break;
                }
            }
    ...
    public String getActiveTaskName() {
        ...
        for( int i = 0; i < taskCount; i++ ) {
            ...
            if( Task.TaskState.IN_PROGRESS == t.getState() ) {
    ...
    public int getCompletedTaskCount() {
       ...
       for( int i = 0; i < taskCount; i++ ) {
           ...
           if( Task.TaskState.COMPLETED == t.getState() ) {
               completedCount++;
           }
       }
