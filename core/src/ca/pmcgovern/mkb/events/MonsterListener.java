...
public class MonsterListener extends ClickListener {
    ...
    public MonsterListener(TaskSpriteManager taskManager, MkbScreen parentScreen, Skin skin, EffectManager effectMgr, TaskSavedListener tsl ) {
        this.parentScreen = parentScreen;
        this.skin = skin;
        this.effectMgr = effectMgr;
        this.taskManager = taskManager;
        this.taskSavedListener = tsl;
    }
    ...
    /**
     * Listen for events fired from TaskSprites. If Event is not a TaskEvent,
...
**/
    class WinChangeListener extends ChangeListener {
        ...
        public void changed(ChangeListener.ChangeEvent event, Actor actor) {
            ...
            Gdx.app.log("MonsterListener", "winchangeListener '" + name + "' " + event);
            ...
            if ("add".equalsIgnoreCase(name)) {
                ...
                TaskForm form = new TaskForm(assetMgr, MonsterListener.this.effectMgr);
                form.addListener( MonsterListener.this.taskSavedListener );
